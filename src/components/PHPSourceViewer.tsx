...
import { Copy, Check, FileText, Download, HelpCircle, Code, Server, Database, RefreshCw } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white p-8 rounded-3xl shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border border-slate-700/30">
          <div className="space-y-2">
            <span className="bg-blue-600/30 text-blue-300 text-[10px] font-extrabold px-3 py-1 rounded-full uppercase tracking-wider border border-blue-500/20 inline-block">
              Host-Ready PHP Source Code Codebase
            </span>
            <h2 className="text-3xl font-display font-bold tracking-tight">Eksportir Kode Sumber PHP</h2>
            <p className="text-slate-300 text-sm max-w-2xl leading-relaxed">
              Ini adalah file PHP utuh, mandiri, dan siap diunggah ke layanan hosting web Anda. Cukup buat database di cPanel, dumping skema SQL, sesuaikan file `.env`, dan sistem MLM Binary Celana Jeans Anda akan berjalan sepenuhnya secara langsung.
            </p>
          </div>
          <div className="p-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur shrink-0 hidden lg:block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-[0_8px_30px_rgb(0,0,0,0.01)] flex items-start gap-4">
            ...
            <div className="space-y-1">
              <h4 className="font-display font-bold text-sm text-slate-900">2. Dump SQL Schema</h4>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-[0_8px_30px_rgb(0,0,0,0.01)] flex items-start gap-4">
            ...
            <div className="space-y-1">
              <h4 className="font-display font-bold text-sm text-slate-900">3. Sesuaikan File .env</h4>
        ...
        {loading ? (
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex flex-col lg:flex-row h-[600px]">
            ...
            <aside className="w-full lg:w-64 border-b lg:border-b-0 lg:border-r border-slate-200/60 bg-slate-50/40 p-4 space-y-3 flex-shrink-0">
              <h4 className="text-[9px] font-extrabold text-slate-400 uppercase tracking-widest px-2">Daftar File PHP Proyek</h4>
